...
const GRUNFELD_EXCHANGE = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'd5', 'cxd5', 'Nxd5', 'e4', 'Nxc3', 'bxc3']
const GRUNFELD_HUNGARIAN = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'd5', 'Nf3', 'Bg7', 'Qb3', 'dxc4', 'Qxc4', 'O-O', 'e4', 'a6']
const GRUNFELD_SMYSLOV = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'd5', 'Nf3', 'Bg7', 'Qb3', 'dxc4', 'Qxc4', 'O-O', 'e4', 'Bg4', 'Be3', 'Nfd7']
const GRUNFELD_TAIMANOV = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'd5', 'Nf3', 'Bg7', 'Bg5', 'Ne4', 'Bh4', 'Nxc3', 'bxc3', 'Qxd5']
const GRUNFELD_GAMBIT = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'd5', 'Bf4', 'Bg7', 'e3', 'O-O', 'cxd5', 'Nxd5', 'Nxd5', 'Qxd5', 'Bxc7']
const NEO_GRUNFELD = ['d4', 'Nf6', 'c4', 'g6', 'g3', 'd5', 'Bg2', 'Bg7', 'Nf3', 'O-O', 'O-O']

const KID_MAIN_LINE = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6', 'Nf3', 'O-O', 'Be2', 'e5', 'O-O', 'Nc6', 'd5', 'Ne7']
const KID_OLD_MAIN_LINE = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6', 'Nf3', 'O-O', 'Be2', 'e5', 'O-O', 'Nbd7']
const KID_PETROSIAN = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6', 'Nf3', 'O-O', 'Be2', 'e5', 'd5']
const KID_GLIGORIC = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6', 'Nf3', 'O-O', 'Be2', 'e5', 'Be3', 'Ng4', 'Bg5', 'f6', 'Bh4', 'Nc6']
const KID_EXCHANGE = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6', 'Nf3', 'O-O', 'Be2', 'e5', 'dxe5', 'dxe5', 'Qxd8', 'Rxd8']
const KID_SAMISCH = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6', 'f3', 'O-O', 'Be3', 'c5']
const KID_PANNO = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6', 'f3', 'Be2', 'O-O', 'Be3', 'Nc6', 'Nge2', 'a6', 'Qd2', 'Rb8']
const KID_AVERBAKH = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6', 'Be2', 'O-O', 'Bg5']
const KID_FOUR_PAWNS = ['d4', 'Nf6', 'c4', 'g6', 'Nc3', 'Bg7', 'e4', 'd6', 'f4', 'O-O', 'Nf3', 'c5', 'd5', 'e6', 'Be2', 'exd5', 'cxd5']
const KID_GALLAGHER = ['d4', 'Nf6', 'c4', 'g6', 'Nf3', 'Bg7', 'g3', 'O-O', 'Bg2', 'd6', 'O-O', 'Nbd7', 'Nc3', 'e5', 'e4', 'exd4', 'Nxd4', 'Re8', 'h3', 'a6']

const BENONI_CZECH = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'e5']
const BENONI_MODERN = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'e6', 'Nc3', 'exd5', 'cxd5', 'd6', 'e4', 'g6', 'f4']
const BENONI_SNAKE = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'e6', 'Nc3', 'exd5', 'cxd5', 'Bd6']
const BENONI_FIANCHETTO = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'e6', 'Nc3', 'exd5', 'cxd5', 'd6', 'Nf3', 'g6', 'g3', 'Bg7', 'Bg2', 'O-O', 'O-O', 'Nbd7', 'Nd2', 'a6', 'a4', 'Re8']
const BENONI_TAIMANOV = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'e6', 'Nc3', 'exd5', 'cxd5', 'd6', 'e4', 'g6', 'f4', 'Bg7', 'Bb5+']
const BENONI_FOUR_PAWNS = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'e6', 'Nc3', 'exd5', 'cxd5', 'd6', 'e4', 'g6', 'f4', 'Bg7', 'Nf3', 'O-O', 'Be2', 'Re8']
const BENONI_CLASSICAL = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'e6', 'Nc3', 'exd5', 'cxd5', 'd6', 'e4', 'g6', 'Nf3', 'Bg7', 'Be2', 'O-O', 'Re8', 'Nd2', 'f3']
const BENKO_MAIN = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'b5', 'cxd5', 'a6', 'bxa6', 'Bxa6', 'Nc3', 'd6', 'e4']
const BENKO_SOSONKO_ACCEPTED = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'b5', 'a4', 'bxc4', 'Nc3', 'e6', 'e4', 'exd5', 'e5']
const BENKO_RIVER_STYX = ['d4', 'Nf6', 'c4', 'c5', 'd5', 'b5', 'a4', 'bxc4', 'Nc3', 'Ba6', 'e4', 'd6', 'f4', 'g6', 'e5']

const DUTCH_TRADITIONAL = ['d4', 'f5', 'c4', 'Nf6', 'g3', 'g6', 'Bg2', 'Bg7', 'Nf3', 'O-O', 'O-O', 'd6']
const DUTCH_COMMON = ['d4', 'f5', 'g3', 'Nf6', 'Bg2', 'g6', 'Nf3', 'Bg7', 'O-O', 'O-O', 'c4', 'd6']
const DUTCH_LENINGRAD = ['d4', 'f5', 'c4', 'Nf6', 'g3', 'g6', 'Bg2', 'Bg7', 'Nf3', 'O-O', 'd6', 'Nc3', 'Nc6']
const DUTCH_BOTVINNIK = ['d4', 'f5', 'c4', 'Nf6', 'g3', 'e6', 'Bg2', 'Be7', 'Nf3', 'O-O', 'O-O', 'd5', 'b3']
const DUTCH_STONEWALL = ['d4', 'f5', 'c4', 'Nf6', 'g3', 'e6', 'Bg2', 'Be7', 'Nf3', 'O-O', 'O-O', 'd5', 'b3', 'c6', 'Ba3']
const DUTCH_ILYIN = ['d4', 'f5', 'c4', 'Nf6', 'g3', 'e6', 'Bg2', 'Be7', 'Nf3', 'O-O', 'O-O', 'd6', 'Nc3', 'Qe8']

const ENGLUND_MAIN = ['d4', 'e5', 'dxe5', 'Nc6', 'Nf3', 'Qe7', 'Bf4', 'Qb4+', 'Bd2', 'Qxb2', 'Nc3', 'Bb4', 'Rb1', 'Qa3', 'Rb3', 'Qa5', 'e4', 'Nge7']
const ENGLUND_BLACKBURNE = ['d4', 'e5', 'dxe5', 'd6', 'exd6', 'Bxd6', 'Nf3', 'Nf6', 'Bg5', 'h6', 'Bh4']
const ENGLUND_SOLLER = ['d4', 'e5', 'dxe5', 'Nc6', 'Nf3', 'f6', 'exf6', 'Nxf6', 'Bg5']
const ENGLUND_FELBECKER = ['d4', 'e5', 'dxe5', 'Bc5', 'Nc3', 'f6', 'exf6', 'Nxf6', 'Bg5', 'd6', 'e3', 'h6']
const ENGLUND_ZILBERMINTS = ['d4', 'e5', 'dxe5', 'Nc6', 'Nf3', 'Nge7', 'Bf4', 'Ng6', 'Bg3', 'Bc5', 'Nc3', 'Qb4', 'Rb1', 'Qa5', 'Qd5', 'Bb4', 'Qxa5', 'Bxa5', 'e3', 'O-O', 'Bd3', 'Re8', 'Bxg6', 'Bxc3+', 'bxc3', 'fxg6']

const ENGLISH_SYMMETRICAL = ['c4', 'e6', 'Nf3', 'd5', 'g3', 'Nf6', 'Bg2', 'Be7', 'O-O', 'c5', 'cxd5', 'Nxd5', 'Nc3', 'Nc6']
const ENGLISH_MIKENAS_FLOHR = ['c4', 'Nf6', 'Nc3', 'e6', 'e4', 'd5', 'e5']
const ENGLISH_BOTVINNIK = ['c4', 'e5', 'Nc3', 'Nc6', 'g3', 'g6', 'Bg2', 'Bg7', 'd3', 'd6', 'e4']
const ENGLISH_TAIMANOV = ['c4', 'e5', 'Nc3', 'Nc6', 'g3', 'g6', 'Bg2', 'Bg7', 'e3', 'd6', 'Nge2', 'Nh6']
const ENGLISH_HORT = ['c4', 'e5', 'Nc3', 'Nc6', 'g3', 'g6', 'Bg2', 'Bg7', 'e3', 'd6', 'Nge2', 'Be6']
const ENGLISH_WIMPEY = ['c4', 'e6', 'Nf3', 'd5', 'b3', 'Nf6', 'Bb2', 'c5', 'e3']
